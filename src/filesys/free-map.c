...
free_map_init (void)
{
  ...
  lock_init(&free_map_lock); /* Initialize lock for free map */
}
...
free_map_allocate (size_t cnt, disk_sector_t *sectorp)
{
  ...
  lock_acquire(&free_map_lock); /* Acquire lock for free_map */
  ...
  lock_release(&free_map_lock); /* Release lock for free_map */
